...
class FlixSearchDetails extends StatefulWidget {
  final String movie;
  final String poster;
  FlixSearchDetails({@required this.movie, @required this.poster, Key key})
      : super(key: key);
  @override
  FlixSearchDetailsState createState() => FlixSearchDetailsState();
}

class FlixSearchDetailsState extends State<FlixSearchDetails> {
  var x = 101;
  String desc = '';
  var movieId;
  String d720 = '';
  ...
  void fetcMov() async {
    ...
    var url = await http.get(
        'https://api.themoviedb.org/3/search/movie?api_key=f04a6a078b473a91b7fdda783e87149d&language=en-US&query=$movie');
