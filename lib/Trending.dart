...
class FlixTrends extends StatefulWidget {
  @override
  _FlixTrendsState createState() => _FlixTrendsState();
}

class _FlixTrendsState extends State<FlixTrends> {
  List poster =List(15);
  List desc = List(15);
  List movie = List(15);
  bool isDone = false;
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      SizedBox(
                                        ...
                                        width: 170,
                                        child: Image.network(
                                          poster[index]!= null? 'https://image.tmdb.org/t/p/w342'+poster[index]:'https://www.ledr.com/colours/grey.jpg',
                                          fit: BoxFit.cover
                                        ),
                                      ),
                                      Container(
